...
<section class="hero" data-testid="clinicians-hero">
    <div class="wrap hero__grid">
      ...
      <div class="feature-row__media reveal" data-delay="2" style="aspect-ratio:5/4;max-width:520px;margin-left:auto">
        <div class="mockup" style="height:100%">
          <div class="mockup__bar"><span></span><span></span><span></span>iPad · Chairside</div>
          <div class="mockup__body">
            <div class="mockup__row"><span class="mockup__badge">Pre-Op</span><div><div class="mockup__row-title">Ms. Priya · Sinus Lift</div><div class="mockup__row-sub">Briefing PDF sent</div></div></div>
            <div class="mockup__row"><span class="mockup__badge" style="background:#FEF3C7;color:#92400E">Surgery</span><div><div class="mockup__row-title">Mr. Rahul · Site #14</div><div class="mockup__row-sub">Drilling protocol ready</div></div></div>
            <div class="mockup__row"><span class="mockup__badge">Lab Slip</span><div><div class="mockup__row-title">Mrs. Nair · Full arch</div><div class="mockup__row-sub">Shade A2 · sent to Nova Lab</div></div></div>
          </div>
        </div>
      </div>
    </div>
  ...
  <section data-testid="clinicians-cta">
    <div class="wrap">
      <div class="big-cta reveal">
        <div>
          <h2>Take a chair back from the paperwork.</h2>
