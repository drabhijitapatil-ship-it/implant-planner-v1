                ...
                {(["maxilla", "mandible"] as const).map((arch) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        Anterior: {a.inputs?.anterior_height_mm ?? "—"} mm
                        height, {a.inputs?.anterior_width_mm ?? "—"} mm width ·
                      ...
                      {(a.treatment_options || []).map(
                        (opt: any, i: number) => (
                          <View
                            ...
                            style={{
                              marginBottom:
                                i === a.treatment_options.length - 1 ? 0 : 8,
                              paddingTop: i === 0 ? 0 : 8,
                              borderTopWidth: i === 0 ? 0 : 1,
                          ...
                          >
                            ...
                            >
                              Treatment Option {i + 1}: {opt.implant_count}{" "}
                              implants ({opt.kind})
                            </Text>
                            <Text
                              style={{
