          ...
          {phase1Done ? (
            ...
            <TouchableOpacity
              ...
              onPress={async () => {
                ...
                Alert.alert(
                  isInchargeUser ? "Mark Case Done" : "Submit for Approval",
                  isInchargeUser
                    ? "Submit this case and auto-approve Phase 1?"
                    : "Are you sure you want to submit this case?",
                  [
                    { text: "Cancel" },
                    {
                      text: isInchargeUser ? "Done" : "Submit",
                      onPress: async () => {
                        try {
                          await api.put(`/procedures/${createdProcedureId}`, {
                          ...
                          if (isInchargeUser) {
                            try {
                              await api.post(
                                `/procedures/${createdProcedureId}/approve`,
        ...
        {formData.implant_procedure_type !== "Existing Implant" && (
          <>
            ...
            {prostheticOptions.length > 0 && (
              <View
                style={styles.section}
                onLayout={showFlowStrip ? onExistingStepLayout(1) : undefined}
              >
                ...
                return (
                  <View style={styles.section}>
                    ...
                    <FdiAnatomicalChart
                      ...
                      selectedLabel={
                        isExtractFlow ? "Selected for extraction" : "Missing"
                      }
                      testIDPrefix="fdi"
                    />
                    {missing.length > 0 && (
                  ...
                  (() => {
                    ...
                    return (
                      <View style={{ marginBottom: 8 }}>
                        ...
                        >
                          Enter the measurements for each tooth marked on the
                          FDI chart. Adjacent missing teeth share one
                          mesiodistal span.
                        </Text>
                        {runs.map((run) => {
                          const archLabel =
                            ...
                            >
                              ...
                              <View style={{ marginBottom: 10 }}>
                                <Text
                                  ...
                                  numberOfLines={1}
                                >
                                  Mesiodistal Space — total cluster span (mm) *
                                </Text>
                                <TextInput
                                  style={[
                                    styles.input,
                              ...
                              {(() => {
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <Dropdown
                                      label="Soft Tissue Thickness"
                                      value={site.soft_tissue_thickness || ""}
                                      options={SOFT_TISSUE_OPTIONS}
                                      onChange={(v) =>
                                        setSite(
                                          leader,
                                    ...
                                    <Dropdown
                                      ...
                                      options={KERATINIZED_MUCOSA_OPTIONS}
                                      onChange={(v) =>
                                        setSite(leader, "keratinized_mucosa", v)
                                      }
              ...
              <>
                ...
                {!isExistingImplantCase && (
                  <>
                    ...
                    >
                      Enter average bone height and width in the anterior and
                      posterior regions for each treated arch. The class and
                      recommended therapeutic options are computed
                      automatically.
                    </Text>
              ...
              >
                ...
                {!canSubmit && !existingSubmitApi.submitting && (
                  ...
                  >
                    ...
                    still incomplete — tap to see what's missing
                  </Text>
                )}
                  ...
                  >
                    ...
                    {!canContinue && !loading && (
                      ...
                      >
                        ...
                        {incompleteCount > 1 ? "s" : ""} still incomplete — tap
