/**
 * Two role tiles connected by pulsing double-chevron arrows. The active tile
...
type Active = 'dentist' | 'incharge';

const TILES: { key: Active; icon: keyof typeof Ionicons.glyphMap; label: string; tint: string }[] = [
  { key: 'dentist',  icon: 'people-outline',           label: 'Dentist',       tint: '#1565C0' },
  { key: 'incharge', icon: 'shield-checkmark-outline', label: 'Chief\nDentist', tint: '#2E7D32' },
];
