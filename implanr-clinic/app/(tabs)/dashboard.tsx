...
function Header({ user, router }: any) {
  const getRoleColor = (role: string) => {
    switch (role) {
      ...
      case 'dentist': return '#1565C0';
      case 'chief_dentist': return '#E65100';
      case 'dental_assistant': return '#2E7D32';
  ...
  const getRoleLabel = (role: string) => {
    switch (role) {
      ...
      case 'chief_dentist': return 'Chief Dentist';
      case 'dental_assistant': return 'Dental Assistant';
