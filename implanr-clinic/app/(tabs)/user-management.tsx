...
export default function UserManagementScreen() {
  ...
  const [newUser, setNewUser] = useState({ name: '', email: '', password: '', role: 'dentist' });
  ...
  const isAdmin = user?.role === 'administrator' || user?.role === 'chief_dentist';
  ...
  const filters = [
    ...
    { key: 'chief_dentist', label: 'Chief Dentist' },
    { key: 'dental_assistant', label: 'Assistants' },
