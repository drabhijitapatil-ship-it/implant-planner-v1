            ...
            <View style={styles.form}>
              ...
              <View style={styles.pickerContainer}>
                <Picker
                  ...
                  style={styles.picker}
                >
                  <Picker.Item label="Dentist / Consultant" value="dentist" />
                  <Picker.Item label="Chief Dentist / Owner" value="chief_dentist" />
                  <Picker.Item label="Administrator" value="administrator" />
                  <Picker.Item label="Dental Assistant (Read-only)" value="dental_assistant" />
                </Picker>
              </View>
