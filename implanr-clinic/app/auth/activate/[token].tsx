...
export default function ActivateScreen() {
  ...
  if (fetchLoading) {
    return (
      <LinearGradient colors={['#F0F9F4', '#E8F5E9', '#C8E6C9']} style={s.center}>
...
const s = StyleSheet.create({
  ...
  errBtn: { backgroundColor: '#2E7D32', borderRadius: 12, paddingHorizontal: 28, paddingVertical: 13 },
  errBtnTxt: { color: '#FFF', fontWeight: '700', fontSize: 15 },
  scroll: { padding: 20, paddingBottom: 48 },
  orgBadge: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#E8F5E9', alignSelf: 'flex-start', borderRadius: 20, paddingHorizontal: 14, paddingVertical: 7, marginBottom: 16 },
  orgName: { fontSize: 14, fontWeight: '600', color: '#2E7D32' },
  ...
  roleHighlight: { color: '#2E7D32', fontWeight: '700' },
