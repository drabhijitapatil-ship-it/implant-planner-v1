      ...
      <html>
        ...
        <body>
          ...
          <div class="section">
            ...
            <table>
              <tr><td class="info-label">Dentist:</td><td class="info-value">${procedure.student_name || procedure.supervisor_name}</td></tr>
              <tr><td class="info-label">Chief Dentist:</td><td class="info-value">${procedure.implant_incharge_name}</td></tr>
            </table>
          </div>
          ...
          <div class="section">
            ...
            ${(procedure.phase2_student_notes || procedure.phase2_remark) ? `<p class="info-value"><strong>Post-Surgical Notes by Dentist:</strong><br/>${procedure.phase2_student_notes || procedure.phase2_remark}</p>` : ''}
            ${procedure.phase2_supervisor_notes ? `<p class="info-value"><strong>Dentist Notes:</strong><br/>${procedure.phase2_supervisor_notes}</p>` : ''}
            ${procedure.phase2_incharge_notes ? `<p class="info-value"><strong>Remarks by Chief Dentist:</strong><br/>${procedure.phase2_incharge_notes}</p>` : ''}
          </div>` : ''}
          ` : ''}
          ...
          <div class="section">
            ...
            ${(procedure.phase3_student_notes || procedure.stage2_surgical_remark) ? `<p class="info-value"><strong>Notes by Dentist:</strong><br/>${procedure.phase3_student_notes || procedure.stage2_surgical_remark}</p>` : ''}
            ${procedure.phase3_supervisor_notes ? `<p class="info-value"><strong>Dentist Notes:</strong><br/>${procedure.phase3_supervisor_notes}</p>` : ''}
            ${procedure.phase3_incharge_notes ? `<p class="info-value"><strong>Remarks by Chief Dentist:</strong><br/>${procedure.phase3_incharge_notes}</p>` : ''}
          </div>` : ''}
          ` : ''}
          ...
          <div class="section">
            ...
            ${(procedure.phase4_step1_student_notes || procedure.stage2_prosthetic_remark) ? `<p class="info-value"><strong>Notes by Dentist:</strong><br/>${procedure.phase4_step1_student_notes || procedure.stage2_prosthetic_remark}</p>` : ''}
            ${procedure.stage2_prosthetic_faculty_remark ? `<p class="info-value"><strong>Dentist Notes:</strong><br/>${procedure.stage2_prosthetic_faculty_remark}</p>` : ''}
            ${procedure.stage2_prosthetic_incharge_remark ? `<p class="info-value"><strong>Remarks by Chief Dentist:</strong><br/>${procedure.stage2_prosthetic_incharge_remark}</p>` : ''}
          </div>` : ''}
          ` : `
          ...
          <div class="section">
            ...
            ${procedure.phase4_step2_student_notes ? `<p class="info-value"><strong>Notes by Dentist:</strong><br/>${procedure.phase4_step2_student_notes}</p>` : ''}
            ${procedure.phase4_step2_supervisor_notes ? `<p class="info-value"><strong>Dentist Notes:</strong><br/>${procedure.phase4_step2_supervisor_notes}</p>` : ''}
            ${procedure.phase4_step2_incharge_notes ? `<p class="info-value"><strong>Remarks by Chief Dentist:</strong><br/>${procedure.phase4_step2_incharge_notes}</p>` : ''}
          </div>` : ''}
          ` : ''}
          ` : ''}
  ...
  <html>
    ...
    <body>
      ...
      <div class="signature-row">
        ...
        <div class="sig-box">${procedure.implant_incharge_name || procedure.supervisor_name || '—'}<br /><span style="color: #888;">Chief Dentist</span></div>
      </div>
