          ...
          <View style={s.infoCard}>
            ...
            {infoModal === 'incharge' ? (
              ...
              <>
                ...
                <Text style={s.infoBody}>
                  Count everyone who will use the app — Implant In-Charges, Supervisors, Postgraduate Students, Undergraduate Students, Fellows, and Auxiliary Staff. This helps plan your workspace capacity.
                </Text>
              </>
            )}
