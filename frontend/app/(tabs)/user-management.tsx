        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent} data-testid="create-user-modal">
            <View style={styles.modalHeader}>
              ...
              <TouchableOpacity onPress={() => setShowCreateModal(false)} data-testid="close-modal-btn">
            ...
            <View style={styles.roleSelector}>
              {ROLE_OPTIONS.map((option) => (
                <TouchableOpacity
                  ...
                  onPress={() => setNewUser({ ...newUser, role: option.value })}
                  data-testid={`role-option-${option.value}`}
                >
                  <Text
                    style={[
                      styles.roleOptionText,
                      newUser.role === option.value && styles.roleOptionTextActive,
                    ]}
                  >
                    {option.label}
                  </Text>
