...
import {
  ...
  printProcedurePDF,
  generateLabSlipPDF,
  generateTerminationSummaryPDF,
  printTerminationSummaryPDF,
  generatePhase3HandoffPDF,
  printPhase3HandoffPDF,
...
export default function ProcedureDetailScreen() {
  ...
  // AI Exit Summary (only for `treatment_ended` cases). Auto-generated
  ...
  const saveField = async (fieldKey: string) => {
    ...
    try {
      ...
      console.log(
        "[saveField] response phase2_data:",
        JSON.stringify(res.data?.phase2_data),
      );
      setProcedure(res.data);
    ...
    return (
      <View key={sectionKey} style={styles.section}>
        ...
        {sectionData.items.map((item: any) => {
          const itemDef = (checklistDef as any)?.items?.find(
            (i: any) => i.id === item.id,
          );
          return (
            ...
            {procedure.status === "completed" && (
              <>
                ...
                >
                  ...
                  >
                    Auto-stamped on case completion. Subsequent edits are
        ...
        */}
                ...
                {(() => {
                  ...
                  return (
                    <View
                      ...
                      testID="treatment-duration-pill"
                  ...
                  >
                    ...
                    >
                      ...
                      <Text style={styles.awaitingText}>
                        Awaiting Student/Nurse to upload the patient consent
                        form
                      </Text>
                    </View>
                  </View>
            ...
            {procedure.status === "permanently_rejected" && (
              ...
              >
                ...
                <Text
                  style={{ fontSize: 13, color: "#C62828", marginBottom: 6 }}
                >
            ...
            {procedure.rejected_phase &&
              ...
              (() => {
                ...
                const isReconsider =
                  ...
                  (phase === "phase3" &&
                    procedure.stage2_surgical_rejection_type ===
                      "reconsider") ||
                  (phase === "phase4" &&
                    procedure.stage2_prosthetic_rejection_type ===
                      "reconsider");
                const reason =
                  phase === "phase1"
                    ? procedure.rejection_reason
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <Text
                        style={{ fontSize: 13, color: "#333", marginTop: 2 }}
                      >
                        {reason || "No reason provided"}
                      </Text>
                    </View>
                    <Text style={{ fontSize: 11, color: "#888", marginTop: 8 }}>
                      Please make the required changes and resubmit this phase
                      for approval.
                    </Text>
                  </View>
                );
        ...
        <AddImplantSection procedure={procedure} onChanged={loadProcedure} />
            ...
            <View
              onLayout={(e) => {
                transferAnchorY.current = e.nativeEvent.layout.y;
              }}
                  ...
                  {procedure.implant_edit_history
                    ...
                    .map((h: any, idx: number) => (
                      <View key={h.id || idx} style={resStyles.editHistoryItem}>
                        ...
                        <Text
                          style={resStyles.editHistoryMeta}
                          numberOfLines={2}
                        >
                          by {h.by_user_name || "Unknown"}
                          {h.by_user_role
            ...
            {(procedure.ai_case_summary || aiSummary) && !editingAiClinical ? (
              ...
              >
                ...
                >
                  ...
                  {user?.role !== "nurse" && procedure.ai_case_summary && (
                    <View style={{ flexDirection: "row", gap: 8 }}>
                      <TouchableOpacity
                        onPress={() => {
                          setAiClinicalDraft(procedure.ai_case_summary || "");
                ...
                >
                  {procedure.ai_case_summary || aiSummary}
                </Text>
              </View>
            ) : null}
            ...
            {editingAiClinical && (
              ...
              >
                ...
                >
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      saveAiSummary("case_summary", aiClinicalDraft)
                    }
                    disabled={aiSavingClinical}
                    style={{
                      paddingVertical: 10,
