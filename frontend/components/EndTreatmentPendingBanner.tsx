/**
 * iter-352: EndTreatmentPendingBanner — shown on the Case Detail page
 * while an End Implant Treatment request is awaiting the next role-based
 * approval (student → supervisor → in-charge). The banner:
