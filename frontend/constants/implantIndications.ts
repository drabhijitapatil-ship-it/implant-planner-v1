...
export const IMPLANT_SYSTEM_DETAILS: Record<string, ImplantSystemDetail> = {
  ...
  // Keys match keyOf() normalization: hyphens and dots collapse to spaces.
  'global d in kone universal': {
    indications:
      'Universal indications — single tooth, multiple unit, and full-arch rehabilitation. Immediate and delayed placement. Healed ridges. Compatible with guided and freehand surgery. Diameters Ø3.5-5.0 mm and lengths 6-15 mm cover most clinical scenarios.',
    features:
      '8° Morse taper Internal Conical Connection with universal prosthetic platform. Bone-level implant. Cylindro-Conical body with double self-tapping threads. SA² (Sand-blasted, Acid-etched) surface. Titanium construction. Compatible with the Ultimate Surgical Kit (shared drilling protocol with the 3.0 Implant).',
  },
  'global d 3 0 implant': {
    indications:
      'Narrow ridges and reduced mesio-distal spaces. Specifically indicated for maxillary lateral incisors (12, 22) and mandibular incisors (31, 32, 41, 42). Use only where a standard-diameter implant cannot be placed without compromising bone width or inter-radicular space.',
    features:
      'Ø3.0 dedicated small-diameter implant. 5° Morse taper Internal Conical Connection on a dedicated 3.0 prosthetic platform. Cylindrical bone-level body with self-tapping thread. SA² surface. Titanium. Dedicated 3.0 Surgical Kit (also compatible with the Ultimate Surgical Kit).',
  },
  'global d twinkone 4': {
    indications:
      'Ultra-short (4 mm length) implant for severely resorbed posterior maxilla and posterior mandible (16, 17, 26, 27, 36, 37, 46, 47). Enables restoration where residual bone height is insufficient for standard implants — allows the clinician to avoid sinus lift procedures in the maxilla and to remain clear of the inferior alveolar nerve in the mandible.',
    features:
      'Ultra-Short cylindrical body (L=4 mm). External Conical Connection on a dedicated prosthetic platform. Self-tapping thread. SA² surface. Titanium. Diameters Ø4.0 and Ø4.5. Dedicated twinkone 4 Surgical Kit.',
  },
};
