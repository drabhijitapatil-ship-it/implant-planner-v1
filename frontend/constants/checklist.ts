    ...
    sections: [
      {
        ...
        items: [
          ...
          { id: 'allergies_meds_reviewed', label: 'Allergies & current medications reviewed',
            tooltip: 'Re-confirm drug allergies (penicillin, latex, local anaesthetic agents). Review current medications — anticoagulants (warfarin / DOACs), bisphosphonates, immunosuppressants, antiplatelets. Hold or bridge as per physician advice.' },
          ...
          { id: 'preop_antibiotic', label: 'Pre-op antibiotic given (if indicated)',
            tooltip: 'Typical regimen: Amoxicillin 2 g PO 1 hour pre-op, or Clindamycin 600 mg if penicillin-allergic. Indicated for routine implant placement, augmentation, immunocompromised patients, or per institutional SOP. Document drug, dose, time.' },
          { id: 'preop_chx_rinse', label: 'Pre-op chlorhexidine rinse done (1 min)', mandatory: true,
            tooltip: 'Chlorhexidine 0.12% or 0.2% rinse for 60 seconds immediately before surgery. Reduces oral bacterial load by ~95%. Avoid eating / drinking after rinse and before draping.' },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'sutures_ready', label: 'Sutures (type, size) ready',
            tooltip: 'Standard implant suturing: 4-0 or 5-0 non-resorbable (PTFE / silk) for primary closure; resorbable (Vicryl) where indicated. Cutting needle for keratinised tissue, reverse cutting for thin mucosa.' },
