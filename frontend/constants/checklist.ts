export const CHECKLIST_DATA = {
  pre_surgical: {
    ...
    items: [
      ...
      { id: 'cbct', label: 'CBCT Slices and Report', hasUpload: true, uploadTypes: 'PDF, Images' },
      ...
      { id: 'realguide', label: 'RealGuide Planning and Report', hasUpload: true, uploadTypes: 'PDF' },
