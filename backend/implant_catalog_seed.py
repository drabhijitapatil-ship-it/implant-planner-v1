...
BIOHORIZONS_TAPERED_PRO: Dict[str, Any] = {
    ...
    "platform_switching": True,
    "features": [
        "Laser-Lok® microchannels at the crest module — 1.8 mm collar zone",
        ...
        "Internal hex prosthetic platforms: 3.0 / 3.5 / 4.5 / 5.7 mm",
    ],
    "implant": {
        "diameters_mm": [3.0, 3.4, 3.8, 4.2, 4.6, 5.0, 5.8, 6.0],
        "lengths_mm": [7.5, 9.0, 10.5, 12.0, 15.0, 18.0],
        "bone_types": ["soft", "dense"],
        "healing_modes": ["two_stage", "single_stage"],
    },
    "components": [
        # Cover screw
        {"type": "cover_screw", "subtype": "Cover Screw (all platforms)",
         "platforms_mm": [3.0, 3.5, 4.5, 5.7], "material": ["titanium_alloy"],
         "retention": ["hand_tighten"],
         "notes": "Submerged surgical healing. Included with each implant."},

        # SmartShape Healers (anterior 1/2, mid 1/2, posterior 1/2)
        {"type": "healing_abutment", "subtype": "SmartShape — Anterior 1",
         "platforms_mm": [3.0, 3.5], "gingival_heights_mm": [4.75, 6.75],
         "material": ["titanium_alloy"], "torque_ncm": [10, 15],
         "indication": "Anatomic emergence shaping for anterior single units."},
        {"type": "healing_abutment", "subtype": "SmartShape — Anterior 2",
         "platforms_mm": [3.0, 3.5], "gingival_heights_mm": [4.75, 6.75],
         "material": ["titanium_alloy"], "torque_ncm": [10, 15]},
        {"type": "healing_abutment", "subtype": "SmartShape — Mid 1",
         "platforms_mm": [3.0, 3.5], "gingival_heights_mm": [4.2, 6.2],
         "material": ["titanium_alloy"], "torque_ncm": [10, 15]},
        {"type": "healing_abutment", "subtype": "SmartShape — Mid 2",
         "platforms_mm": [3.0, 3.5, 4.5], "gingival_heights_mm": [4.2, 6.2],
         "material": ["titanium_alloy"], "torque_ncm": [10, 15]},
        {"type": "healing_abutment", "subtype": "SmartShape — Posterior 1",
         "platforms_mm": [3.5, 4.5, 5.7], "gingival_heights_mm": [3.0, 4.5],
         "material": ["titanium_alloy"], "torque_ncm": [10, 15]},
        {"type": "healing_abutment", "subtype": "SmartShape — Posterior 2",
         "platforms_mm": [3.5, 4.5, 5.7], "gingival_heights_mm": [3.0, 4.5],
         "material": ["titanium_alloy"], "torque_ncm": [10, 15]},

        # Laser-Lok Healing Abutments (Narrow / Regular / Wide emergence)
        {"type": "healing_abutment", "subtype": "Laser-Lok — Narrow emergence",
         "platforms_mm": [3.5, 4.5, 5.7], "gingival_heights_mm": [3, 5],
         "material": ["titanium_alloy"],
         "notes": "Laser-Lok microchannels around the soft-tissue collar."},
        {"type": "healing_abutment", "subtype": "Laser-Lok — Regular emergence",
         "platforms_mm": [3.0, 3.5, 4.5, 5.7], "gingival_heights_mm": [3, 5],
         "material": ["titanium_alloy"]},
        {"type": "healing_abutment", "subtype": "Laser-Lok — Wide emergence",
         "platforms_mm": [3.0, 3.5, 4.5], "gingival_heights_mm": [3, 5],
         "material": ["titanium_alloy"]},

        # Standard Healing Abutments (Narrow / Regular / Wide / Extra-Wide emergence)
        {"type": "healing_abutment", "subtype": "Standard — Narrow emergence",
         "platforms_mm": [3.0, 3.5, 4.5, 5.7], "gingival_heights_mm": [1, 2, 3, 5],
         "material": ["titanium_alloy"]},
        {"type": "healing_abutment", "subtype": "Standard — Regular emergence",
         "platforms_mm": [3.0, 3.5, 4.5, 5.7], "gingival_heights_mm": [3, 5],
         "material": ["titanium_alloy"]},
        {"type": "healing_abutment", "subtype": "Standard — Wide emergence",
         "platforms_mm": [3.0, 3.5, 4.5, 5.7], "gingival_heights_mm": [3, 5],
         "material": ["titanium_alloy"]},
        {"type": "healing_abutment", "subtype": "Standard — Wide emergence (extra wide)",
         "platforms_mm": [3.0, 3.5, 4.5, 5.7], "gingival_heights_mm": [3, 5, 6, 7, 8],
         "material": ["titanium_alloy"]},

        # Temporary cylinders
        {"type": "temporary_cylinder", "subtype": "Laser-Lok Easy Ti Abutments — Hexed",
         "platforms_mm": [3.0, 3.5, 4.5, 5.7], "lengths_mm": [9.5],
         "material": ["titanium_alloy_TiN"], "torque_ncm": [30],
         "indication": "Single-unit screw-retained, long-term temporary restorations."},
        {"type": "temporary_cylinder", "subtype": "Easy Ti Abutments — Non-hexed",
         "platforms_mm": [3.0, 3.5, 4.5, 5.7], "lengths_mm": [9.5],
         "material": ["titanium_alloy_TiN"], "torque_ncm": [30],
         "indication": "Multi-unit / non-engaging temporary cylinders."},

        # Final / custom abutments
        {"type": "final_abutment", "subtype": "Easy Ti Abutments (Hexed / Non-hexed)",
         "platforms_mm": [3.0, 3.5, 4.5, 5.7], "material": ["titanium_alloy"],
         "torque_ncm": [30],
         "indication": "Pre-made customizable Ti abutment for cement-retained crowns."},
        {"type": "final_abutment", "subtype": "Custom Milled Abutment (titanium / zirconia)",
         "material": ["titanium_alloy", "zirconia"], "cad_cam": True,
         "torque_ncm": [30],
         "notes": "Milled in-house or via partner milling centres."},

        # Multi-Unit Abutments (Straight + Angled)
        {"type": "multi_unit_abutment", "subtype": "Straight MUA",
         "platforms_mm": [3.5, 4.5, 5.7], "gingival_heights_mm": [1, 2, 3, 4, 5],
         "material": ["titanium_alloy"], "torque_ncm": [30]},
        {"type": "multi_unit_abutment", "subtype": "Angled MUA — 17°",
         "platforms_mm": [3.5, 4.5, 5.7], "gingival_heights_mm": [2, 3, 4, 5],
         "angulation_deg": [17], "material": ["titanium_alloy"], "torque_ncm": [30]},
        {"type": "multi_unit_abutment", "subtype": "Angled MUA — 30°",
         "platforms_mm": [3.5, 4.5, 5.7], "gingival_heights_mm": [2, 3, 4, 5],
         "angulation_deg": [30], "material": ["titanium_alloy"], "torque_ncm": [30]},

        # Ti-Base / CAD-CAM
        {"type": "ti_base", "subtype": "Ti-Base for Crown (Hexed)",
         "platforms_mm": [3.0, 3.5, 4.5, 5.7], "gingival_heights_mm": [0.5, 1.5, 3.0],
         "material": ["titanium_alloy"], "cad_cam": True, "torque_ncm": [30]},
        {"type": "ti_base", "subtype": "Ti-Base for Bridge (Non-hexed)",
         "platforms_mm": [3.5, 4.5, 5.7], "material": ["titanium_alloy"],
         "cad_cam": True, "torque_ncm": [30]},
        {"type": "ti_base", "subtype": "MUA Ti-Base",
         "material": ["titanium_alloy"], "cad_cam": True,
         "indication": "For multi-unit screw-retained CAD/CAM bridges and full arches."},

        # Scan bodies
        {"type": "scanbody", "subtype": "Implant Scanbody",
         "platforms_mm": [3.0, 3.5, 4.5, 5.7], "material": ["PEEK", "titanium_alloy"],
         "indication": "Direct-to-implant intraoral / lab digital impressioning."},
        {"type": "scanbody", "subtype": "MUA Scanbody",
         "material": ["PEEK", "titanium_alloy"],
         "indication": "Multi-unit abutment level digital impressioning."},

        # Impression copings
        {"type": "impression_coping", "subtype": "Open Tray Impression Coping",
         "platforms_mm": [3.0, 3.5, 4.5, 5.7], "material": ["titanium_alloy"],
         "indication": "Pick-up technique for accurate multi-unit conventional impressions."},
        {"type": "impression_coping", "subtype": "Closed Tray Impression Coping",
         "platforms_mm": [3.0, 3.5, 4.5, 5.7], "material": ["titanium_alloy"],
         "indication": "Snap-on technique for single-unit conventional impressions."},
        {"type": "impression_coping", "subtype": "MUA Open Tray Coping",
         "material": ["titanium_alloy"]},
        {"type": "impression_coping", "subtype": "MUA Closed Tray Coping",
         "material": ["titanium_alloy"]},

        # Lab analogs
        {"type": "analog", "subtype": "Implant Lab Analog",
         "platforms_mm": [3.0, 3.5, 4.5, 5.7], "material": ["stainless_steel"],
         "indication": "Soft-tissue / stone model fabrication."},
        {"type": "analog", "subtype": "MUA Lab Analog",
         "material": ["stainless_steel"]},

        # Castable / UCLA / coping
        {"type": "castable_abutment", "subtype": "Castable UCLA — Hexed (with gold sleeve)",
         "platforms_mm": [3.0, 3.5, 4.5, 5.7],
         "material": ["gold_alloy", "Polyoxymethylene (Acetal Resin)"],
         "indication": "Custom cast-on UCLA. Not for sale in the USA."},
        {"type": "castable_abutment", "subtype": "Castable MUA Cylinder",
         "material": ["gold_alloy", "Polyoxymethylene (Acetal Resin)"]},
        ...
        {"type": "prosthetic_screw", "subtype": "Abutment Screw",
         "platforms_mm": [3.0, 3.5, 4.5, 5.7], "material": ["titanium_alloy"],
         "torque_ncm": [30]},
        {"type": "prosthetic_screw", "subtype": "MUA Prosthetic Screw",
         "material": ["titanium_alloy"], "torque_ncm": [15]},
        {"type": "prosthetic_screw", "subtype": "Try-in Screw",
         "platforms_mm": [3.0, 3.5, 4.5, 5.7], "material": ["titanium_alloy"]},

        # Overdenture attachments — LOCATOR R-Tx + classic LOCATOR + OD Secure + Ball
        {"type": "overdenture_attachment", "subtype": "LOCATOR® R-Tx Abutment",
         "platforms_mm": [3.0, 3.5, 4.5, 5.7],
         "gingival_heights_mm": [0.5, 1, 2, 3, 4, 5, 6],
         "material": ["titanium_alloy"], "retention": ["nylon_retention_insert"],
         "torque_ncm": [30],
         "notes": "Each kit: 1 abutment + 1 denture housing (black processing insert) + 4 nylon retention inserts + 1 block-out spacer."},
        {"type": "overdenture_attachment", "subtype": "OD Secure Abutment System",
         "platforms_mm": [3.0, 3.5, 4.5, 5.7],
         "gingival_heights_mm": [0, 1, 2, 3, 4, 5, 6],
         "material": ["titanium_alloy_TiN"], "retention": ["retention_insert"],
         "torque_ncm": [30],
         "notes": "Includes abutment, housing, 4 retentive inserts, lab processing insert, protection disk."},
        {"type": "overdenture_attachment", "subtype": "LOCATOR® Multi-Unit Abutment (Ti Collar)",
         "material": ["titanium_alloy"], "retention": ["locator_male"],
         "indication": "MUA-level overdenture retention."},
        {"type": "overdenture_attachment", "subtype": "LOCATOR® Multi-Unit Abutment (Delrin® Collar)",
         "material": ["delrin"], "retention": ["locator_male"]},
        {"type": "overdenture_attachment", "subtype": "LOCATOR® Fixed Processing Pack — Green (4-implant)",
         "retention": ["locator_fixed_insert"]},
        {"type": "overdenture_attachment", "subtype": "LOCATOR® Fixed Processing Pack — Tan (Anterior/Posterior, 5+)",
         "retention": ["locator_fixed_insert"]},
        {"type": "overdenture_attachment", "subtype": "LOCATOR® Fixed Processing Pack — Blue (Mid Arch, 5+)",
         "retention": ["locator_fixed_insert"]},
        {"type": "overdenture_attachment", "subtype": "Ball Abutment — 1 mm collar",
         "platforms_mm": [3.0, 3.5, 4.5, 5.7], "material": ["titanium_alloy"],
         "retention": ["o_ring"], "torque_ncm": [30],
         "indication": "Tissue-supported overdenture retention."},
        {"type": "overdenture_attachment", "subtype": "Ball Abutment — 3 mm collar",
         "platforms_mm": [3.0, 3.5, 4.5, 5.7], "material": ["titanium_alloy"],
         "retention": ["o_ring"], "torque_ncm": [30]},
        {"type": "overdenture_attachment", "subtype": "Ball Abutment — 5 mm collar",
         "platforms_mm": [3.0, 3.5, 4.5, 5.7], "material": ["titanium_alloy"],
         "retention": ["o_ring"], "torque_ncm": [30]},
    ],
    "compatibility_notes": (
        "Internal hex prosthetic system, color-coded by platform diameter "
        "(3.0 / 3.5 / 4.5 / 5.7 mm). Surgical kits, drills, and instruments are designed "
        "specifically for Tapered Pro implant geometry. Use only BioHorizons-approved "
        "components to maintain warranty and seal integrity. Final abutment torque: 30 Ncm."
    ),
}
...
BIOHORIZONS_TAPERED_PRO_CONICAL: Dict[str, Any] = {
    ...
    "components": [
        ...
        {"type": "impression_coping", "subtype": "Conical Impression Cap (POM, 5-pack)",
         "platforms": ["Narrow", "Regular"],
         "material": ["Polyoxymethylene (Acetal Resin)"], "part_numbers": ["CNIC", "CRIC"],
        ...
        {"type": "impression_coping", "subtype": "Bite Registration Cap (POM, 5-pack)",
         "platforms": ["Narrow", "Regular"],
         "material": ["Polyoxymethylene (Acetal Resin)"], "part_numbers": ["CNBRC", "CRBRC"],
        ...
        {"type": "final_abutment", "subtype": "Conical Gold-Plastic Abutment",
         "platforms": ["Narrow", "Regular"],
         "heights_mm": [11.7],
         "material": ["gold_alloy", "Polyoxymethylene (Acetal Resin)"], "retention": ["abutment_screw"],
         "torque_ncm": 20,
        ...
        {"type": "coping", "subtype": "Gold Custom Castable Coping",
         "platforms": ["Multi-unit"],
         "heights_mm": [7.5],
         "material": ["gold_alloy", "Polyoxymethylene (Acetal Resin)"], "retention": ["prosthetic_screw"],
         "torque_ncm": 15,
         "part_numbers": ["PXMUGC"],
        ...
        {"type": "coping", "subtype": "Plastic Custom Castable Coping",
         "platforms": ["Multi-unit"],
         "heights_mm": [7.5],
         "material": ["Polyoxymethylene (Acetal Resin)"], "retention": ["prosthetic_screw"],
         "torque_ncm": 15,
         "part_numbers": ["PXMUPC"],
        ...
        {"type": "coping", "subtype": "Passive-Fit Coping",
         "platforms": ["Multi-unit"],
         "heights_mm": [7.5],
         "material": ["titanium_alloy", "Polyoxymethylene (Acetal Resin)"], "retention": ["prosthetic_screw"],
         "torque_ncm": 15,
...
CONELOG_PROGRESSIVE: Dict[str, Any] = {
    ...
    "components": [
        ...
        {"type": "impression_coping", "subtype": "CONELOG Impression posts, closed tray",
         "platforms": ["3.3", "3.8", "4.3", "5.0"],
         "diameters_mm": [3.3, 3.8, 4.3, 5.0],
         "material": ["titanium_alloy", "Polyoxymethylene (Acetal Resin)"], "retention": ["abutment_screw"],
        ...
        {"type": "impression_coping", "subtype": "Impression caps for closed tray (POM, 5-pack)",
         "platforms": ["3.3", "3.8", "4.3", "5.0"],
         "diameters_mm": [3.3, 3.8, 4.3, 5.0],
         "material": ["Polyoxymethylene (Acetal Resin)"],
        ...
        {"type": "final_abutment", "subtype": "CONELOG Gold-plastic abutment",
         ...
         "diameters_mm": [3.3, 3.8, 4.3, 5.0],
         "heights_mm": [11.7],
         "material": ["cast_on_gold_alloy", "Polyoxymethylene (Acetal Resin)"], "retention": ["cement"],
...
_SKY_RP_PROSTHETICS = [
    ...
    {"type": "temporary_cylinder", "subtype": "SKY temp S abutment",
     ...
     "material": ["Polyoxymethylene (Acetal Resin)"], "torque_ncm": 18,
